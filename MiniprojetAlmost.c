...
void Stats()
{
    ...
    case 2:
        ...
        printf("----------------------------\n");
        printf("Age moyen des joueurs: %d\n", AgeTotal / cmptjrs);
        printf("----------------------------\n");
        break;
    case 3:
...
int main()
{
    ...
    while (1)
    {
        printf("1. Ajouter un joueurs.\n");
        printf("2. Afficher un joueurs.\n");
        printf("3. Modifier un joueurs.\n");
        printf("4. Supprimer un joueurs.\n");
        printf("5. Rechercher un joueurs.\n");
